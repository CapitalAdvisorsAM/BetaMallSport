...
- Migraciones en repo: **38**
- Migraciones registradas en DB: **39**
...
| RegistroContable | RegistroContable_localId_periodo_idx | 163 | 224.0 KB |
| RegistroContable | RegistroContable_arrendatarioId_periodo_idx | 20 | 176.0 KB |
| RegistroContable | RegistroContable_proyectoId_grupo1_periodo_idx | 286 | 176.0 KB |
...
| RegistroContable | RegistroContable_proyectoId_arrendatarioId_periodo_idx | 38 | 88.0 KB |
...
| migration | 20260419110001_add_project_scoped_integrity | drift | Migración del repo no registrada en _prisma_migrations. |
...
| MovimientoBanco | true | true | true | true |
| PresupuestoGasto | true | true | true | true |
| Proyecto | true | true | true | true |
| RegistroBalance | true | true | true | true |
...
2. [CRITICAL] La credencial auditada no opera con privilegios read-only mínimos
   ...
   Query: `scripts/db-audit/sql/security_role_privileges.sql`, `scripts/db-audit/sql/security_table_privileges.sql`
...
4. [HIGH] Schema/migraciones con drift respecto del repo
   ...
   Query: `scripts/db-audit/sql/migrations_applied.sql`, `scripts/db-audit/sql/table_inventory.sql`, `scripts/db-audit/sql/index_inventory.sql`
...
5. [HIGH] La credencial puede leer PII y tokens de autenticación
   ...
   Query: `scripts/db-audit/sql/security_table_privileges.sql`, `scripts/db-audit/sql/column_inventory.sql`
