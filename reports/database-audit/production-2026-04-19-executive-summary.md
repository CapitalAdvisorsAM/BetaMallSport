...
- Evidencia reproducible: `scripts/db-audit/sql/security_role_privileges.sql + security_table_privileges.sql`
...
- Evidencia reproducible: `scripts/db-audit/sql/_prisma_migrations + introspección de tablas/índices`
...
- Evidencia reproducible: `scripts/db-audit/sql/security_table_privileges.sql + column_inventory.sql`
