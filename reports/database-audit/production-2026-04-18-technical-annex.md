...
| RegistroContable | RegistroContable_proyectoId_arrendatarioId_periodo_idx | 37 | 88.0 KB |
...
| --- | --- | --- | --- |
| table | PresupuestoGasto | drift | Tabla esperada no encontrada. |
...
| migration | 20260418000000_add_report_date_and_expense_budget | drift | Migración del repo no registrada en _prisma_migrations. |
...
4. [HIGH] Schema/migraciones con drift respecto del repo
   Evidencia: 9 objetos en estado drift entre Prisma, migraciones y PostgreSQL.
