...
const DENSITY_THEME_TOKENS: Record<TableDensity, DensityThemeTokens> = {
  compact: {
    headCell: "px-3 py-1.5 text-left text-[10px] font-bold uppercase tracking-widest text-white/70",
    cell: "px-3 py-1.5 text-slate-700",
    compactCell: "px-2.5 py-1 text-slate-700",
    compactHeadCell: "px-2.5 py-1 text-left text-[10px] font-bold uppercase tracking-widest text-white/70"
  },
  default: {
  ...
  comfortable: {
    headCell: "px-5 py-2.5 text-left text-[10px] font-bold uppercase tracking-widest text-white/70",
    cell: "px-5 py-2.5 text-slate-700",
    compactCell: "px-3 py-1.5 text-slate-700",
    compactHeadCell: "px-3 py-1.5 text-left text-[10px] font-bold uppercase tracking-widest text-white/70"
  }
};
