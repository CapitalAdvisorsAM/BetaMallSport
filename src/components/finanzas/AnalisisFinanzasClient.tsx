...
import { formatEerr } from "@/lib/finanzas/eerr";
import type { AnalisisFila, AnalisisResponse } from "@/app/api/finanzas/analisis/route";
...
export function AnalisisFinanzasClient({
  projects,
  selectedProjectId,
  defaultDesde,
  defaultHasta
  ...
  const fetchOpciones = useCallback(async () => {
    ...
    const res = await fetch(`/api/finanzas/analisis?${params}`);
