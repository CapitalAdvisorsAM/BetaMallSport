...
const columns: ColumnDef[] = [
  ...
  {
    key: "multiplicadorJunio",
    label: "Multiplicador Junio",
    required: false,
    description: "Opcional. Factor decimal para junio. Ej: 1.25",
    format: "number",
    width: 22,
    headerPalette: "slate"
  },
  ...
  },
  {
    ...
    required: false,
    description: "Opcional. Factor decimal para agosto. Ej: 1.25",
    format: "number",
    width: 22,
    headerPalette: "slate"
  },
