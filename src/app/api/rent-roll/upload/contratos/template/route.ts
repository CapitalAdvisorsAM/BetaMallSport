...
const instruccionesGenerales = [
  ...
  "Para renta variable use una sola fila por contrato en la columna Renta Variable %; el sistema aplica las fechas del contrato automaticamente. Un contrato puede tener tarifa fija y renta variable al mismo tiempo: complete ambas columnas en la misma fila",
