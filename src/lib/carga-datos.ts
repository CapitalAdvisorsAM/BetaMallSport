  ...
  return (
    ...
    value.every(
      (item) =>
        ...
        (item.fechaEntrega === undefined || item.fechaEntrega === null || typeof item.fechaEntrega === "string") &&
        (item.fechaApertura === undefined ||
          item.fechaApertura === null ||
          typeof item.fechaApertura === "string") &&
        ...
        (item.ggccPctReajuste === undefined ||
          item.ggccPctReajuste === null ||
          typeof item.ggccPctReajuste === "string") &&
